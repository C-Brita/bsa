...
from bsa.training_elas import fit
from bsa.experiments.datasets import ElasDataset
from bsa.experiments.wrappers import ElasModel
...
if __name__ == "__main__":
    ...
    args.num_epochs = args.num_epochs * len(train_dataset) // args.batch_size
